            ...
            <div className={styles.footerGrid}>
              ...
              <div className={styles.footerColumn}>
                ...
                <ul className={styles.footerMenu}>
                  ...
                  <li>
                    <Link to="/what-we-do/domestic-market">Products</Link>
                  </li>
                  <li>
                    <Link to="/our-brands">Our Brands</Link>
                  </li>
                  <li>
                    <Link to="/what-we-do/quality-assurance">Quality Assurance</Link>
                  </li>
                </ul>
              </div>
              ...
              <div className={styles.footerColumn}>
                ...
                <ul className={styles.footerMenu}>
                  <li>
                    <Link to="/what-we-do/exports">Exports</Link>
                  </li>
                  <li>
                    <Link to="/career#culture-at-al-maha">Work With Us</Link>
                  </li>
                  <li>
                    <Link to="/contact-us">Contact Us</Link>
                  </li>
                  <li>
                    <Link to="/corporate-social-responsibility">Corporate Social Responsibility</Link>
                  </li>
                </ul>
              </div>
              ...
              <div className={styles.footerColumn}>
                ...
                {/* Copyright — moved into the fourth column so it stays with contact/social */}
                <div className={styles.columnCopyright}>
