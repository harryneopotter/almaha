...
import styles from './CultureAtAlMahaSection.module.css';

const CultureAtAlMahaSection = () => {
  return (
        ...
        <div className={styles.container}>
          <div className={styles.contentWrapper}>
            ...
            <div className={styles.leftColumn}>
              ...
              <div className={styles.workWithUsImage}>
            ...
            <div className={styles.rightColumn}>
              ...
              <div className={styles.description}>
                <p><strong>Bringing The Best out of the Team</strong></p>
          ...
          <div className={styles.contentWrapper}>
            ...
            <div className={styles.rightColumn}>
              ...
              <div className={styles.lifeGallery}>
                <div className={styles.lifeGalleryItem}>
...
export default CultureAtAlMahaSection;
